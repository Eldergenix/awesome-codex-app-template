...
import type { Selections, AppType, LayoutStyle, Theme } from "./types";
          ...
          <div key={stepNum} style={{ display: "flex", alignItems: "center", flex: i < TOTAL_STEPS - 1 ? 1 : undefined }}>
            <div
              style={{
                ...
                color: isDone ? "#fff" : isActive ? COLORS.primary : COLORS.inkTertiary,
    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 24px", boxSizing: "border-box" }}>
      ...
      >
        ...
        <div style={{ minHeight: "360px" }}>
          ...
          {step === 6 && <Review selections={selections} onConfirm={() => setStep(7)} onBack={back} />}
          {step === 7 && <ExecutionLog selections={selections as Record<string, unknown>} onReset={handleReset} />}
        </div>

        {/* Navigation — only shown on form steps 1-5 */}
        {step <= TOTAL_STEPS && (
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "36px", paddingTop: "24px", borderTop: `1px solid ${COLORS.hairline}` }}>
            <button
              id="wizard-back"
              onClick={back}
              disabled={step === 1}
            ...
            <button
              ...
              style={{
                ...
                color: canAdvance() ? "#fff" : COLORS.inkTertiary,
                fontSize: "13px",
                fontWeight: 600,
